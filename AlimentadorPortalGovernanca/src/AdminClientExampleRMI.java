...
public class AdminClientExampleRMI implements NotificationListener
{
    ...
    {
       AdminClientExampleRMI ace = new AdminClientExampleRMI();

       // Create an AdminClient
       ace.createAdminClient();

       // Find a NodeAgent MBean
       ace.getNodeAgentMBean("*");
    ...
    private void createAdminClient()
    {
        ...
        connectProps.setProperty(AdminClient.CONNECTOR_HOST, "9.17.159.60");
...
//        System.setProperty("com.ibm.SOAP.ConfigURL", "file:C:/MyThinClient/70properties/soap.client.props");
        connectProps.setProperty(AdminClient.USERNAME, "connections");
    ...
    private void getNodeAgentMBean(String nodeName)
    {
        ...
        try
        {
            ...
            String query = "WebSphere:type=NodeAgent,node=" + node + ",*";
            ...
            {
            	query = "WebSphere:type=NodeAgent,node=*";
            	queryName = new ObjectName(query);
            	adminClient.queryMBeans(queryName, null);
